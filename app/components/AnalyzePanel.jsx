    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div className="w-full max-w-md rounded-xl border border-neutral-200 bg-white p-8 shadow-xl">
        ...
        <p className="mt-3 text-[15px] leading-relaxed text-neutral-600">
          Subscribe for <strong>$99/month</strong> for unlimited FDA import alert analyses, resolution pathways, and ready-to-submit response letters.
        </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              {loading ? (
                <p className="text-center text-sm text-neutral-500" role="status">
                  Reading the alert, identifying violations, and drafting your response letter... this usually takes about a minute.
                </p>
              ) : null}
              <button
                type="submit"
              ...
              >
                {loading ? "Analyzing your alert - hang tight..." : hasUsedFree ? "Subscribe to Analyze" : "Analyze an Alert"}
              </button>
              <p className="text-center text-sm text-neutral-500">
                {hasUsedFree ? (
                  <a href={STRIPE_LINK} target="_blank" rel="noopener noreferrer" className="text-blue-600 underline underline-offset-4">
